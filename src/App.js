...
function App() {
  ...
  const faceIoScriptLoaded = () => {
    ...
    if (faceIO && !faceioInstance) {
      faceioInstance = new faceIO('fioa7204');
    }
  }
  ...
  return (
    ...
    <div className="face-authentication-by-thanhphongdev flex fdc jcfc aic">
      <img src='https://news.mit.edu/sites/default/files/styles/news_article__image_gallery/public/images/202203/face-600x900.png?itok=4wm2x8C2'></img>
